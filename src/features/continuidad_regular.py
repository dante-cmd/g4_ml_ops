...
def main(args):
    ...
    # for Continuidad
    output_feats_continuidad_datastore = args.output_feats_continuidad_datastore
    output_target_continuidad_datastore = args.output_target_continuidad_datastore
